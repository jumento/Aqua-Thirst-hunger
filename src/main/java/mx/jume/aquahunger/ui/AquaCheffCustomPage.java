...
public class AquaCheffCustomPage extends InteractiveCustomUIPage<AquaCheffCustomPage.PageData> {
    ...
    public AquaCheffCustomPage(@Nonnull PlayerRef playerRef) {
    ...
    public void build(@Nonnull Ref<EntityStore> ref, @Nonnull UICommandBuilder cmd, @Nonnull UIEventBuilder evt,
        ...
        cmd.append("Pages/AquaCheffCustomUI.ui");
        ...
        evt.addEventBinding(CustomUIEventBindingType.Activating, "#BtnLifePerHunger",
                new com.hypixel.hytale.server.core.ui.builder.EventData().append("Action", "life_per_hunger"));
    ...
    public void handleDataEvent(@Nonnull Ref<EntityStore> ref, @Nonnull Store<EntityStore> store,
        ...
        switch (data.action) {
            ...
            case "thirst_config":
                ...
                break;
            case "life_per_hunger":
                player.getPageManager().openCustomPage(ref, store,
                        new AquaLifePerHungerPage(this.playerRef, AquaThirstHunger.get().getConfigManager()));
                break;
            case "close":
                player.getPageManager().openCustomPage(ref, store, new AquaCheffConfigPage(this.playerRef));
                break;
        }
    }
}
