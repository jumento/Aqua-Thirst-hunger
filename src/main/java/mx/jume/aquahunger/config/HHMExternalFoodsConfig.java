...
public class HHMExternalFoodsConfig {
    ...
    private String configVersion = "1.6.1";
    ...
    private void loadFile(File file, Map<String, ExternalFoodEntry> targetMap, String type) {
        if (!file.exists()) {
            //AquaThirstHunger.logDebug("ExternalFoods " + type + " config not found: " + file.getName());
            return;
        }
        ...
        try (FileReader reader = new FileReader(file)) {
            ...
            if (raw != null) {
                ...
                //AquaThirstHunger.logDebug("Loaded " + count + " items from " + file.getName()
    ...
    private void rebuildMerged() {
        ...
        //AquaThirstHunger.logDebug("Merged configuration: " + mergedEntries.size() + " total items ("
    ...
    private void saveFile(File file, Map<String, ExternalFoodEntry> entries, boolean includeVersion) {
        try {
            ...
            //AquaThirstHunger.logDebug("Saved " + entries.size() + " items to " + file.getName());
        } catch (IOException e) {
    ...
    private void copyAndLog(java.io.InputStream in) throws IOException {
        ...
        //AquaThirstHunger.logDebug("Successfully refreshed " + defaultConfigFile.getName() + " from internal mod data.");
    }
