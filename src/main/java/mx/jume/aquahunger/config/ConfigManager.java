...
public class ConfigManager {
    ...
    public void reload() throws Exception {
        ...
        this.hungerConfig.ensureDefaults();
        //AquaThirstHunger.logInfo("[aquahunger] Reloaded HungerConfig. LifePerHunger=" + this.hungerConfig.isLifePerHunger());

        this.thirstConfig = newThirstConfig;
        this.thirstConfig.ensureDefaults();
        //AquaThirstHunger.logInfo("[aquahunger] Reloaded ThirstConfig.");

        this.foodValuesConfig = newFoodValuesConfig;
        this.foodValuesConfig.ensureDefaults();
        //AquaThirstHunger.logInfo("[aquahunger] Reloaded FoodValuesConfig.");
        ...
        //AquaThirstHunger.logInfo("[aquahunger] Reloaded ThirstFoodValuesConfig.");

        this.externalFoodsConfig = newExternalFoodsConfig;
        //AquaThirstHunger.logInfo("[aquahunger] Reloaded ExternalFoodsConfig.");

        // 4. Save to ensure consistency
        save();

        //AquaThirstHunger.logInfo("[aquahunger] Configuration reloaded successfully.");
    }
